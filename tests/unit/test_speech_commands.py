...
async def test_speech_command_admin_on() -> None:
    ...
    # Mock the service registry in context
    ...
    mock_service_registry.get_service.return_value = config_manager
    context.application.bot_data = {'service_registry': mock_service_registry}
