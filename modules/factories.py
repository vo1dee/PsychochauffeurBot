...
class ServiceFactory(ABC):
    ...
    @abstractmethod
    def create(self, service_registry: ServiceRegistry, **kwargs) -> Any:
...
class ConfigurableServiceFactory(ServiceFactory):
    ...
    def __init__(self, service_type: Type[T], default_config: Dict[str, Any] = None):
        self.service_type = service_type
        self.default_config = default_config or {}
    
    def create(self, service_registry: ServiceRegistry, **kwargs) -> T:
...
class DependencyInjectingFactory(ServiceFactory):
    ...
    def __init__(self, service_type: Type[T], dependencies: Dict[str, str] = None):
        self.service_type = service_type
...
class ServiceFactoryRegistry:
    ...
    def register_configurable(self, name: str, service_type: Type[T], default_config: Dict[str, Any] = None) -> None:
    ...
    def register_singleton(self, name: str, service_type: Type[T]) -> None:
        """Register a singleton service factory."""
        factory = SingletonServiceFactory(service_type)
        self.register_factory(name, factory)
    
    def register_with_dependencies(self, name: str, service_type: Type[T], dependencies: Dict[str, str]) -> None:
        """Register a service factory with dependency injection."""
        factory = DependencyInjectingFactory(service_type, dependencies)
        self.register_factory(name, factory)
    
    def create_service(self, name: str, service_registry: ServiceRegistry, **kwargs) -> Any:
...
class TelegramCommand(Command):
    ...
    def __init__(self, update, context, service_registry: ServiceRegistry):
        self.update = update
...
class MessageCommand(TelegramCommand):
    ...
    def __init__(self, update, context, service_registry: ServiceRegistry, message_processor):
...
class CallbackCommand(TelegramCommand):
    ...
    def __init__(self, update, context, service_registry: ServiceRegistry, callback_processor):
        super().__init__(update, context, service_registry)
...
class CommandFactory:
    ...
    def create_message_command(self, update, context) -> MessageCommand:
    ...
    def create_callback_command(self, update, context) -> CallbackCommand:
