...
class StandardError(Exception):
    ...
    def __str__(self):
        ...
        if self.original_exception:
            base += f" (Caused by: {type(self.original_exception).__name__}: {str(self.original_exception)})"
        return base
...
class ErrorHandler:
    ...
    @staticmethod
    def format_error_message(error: Union[StandardError, Exception], 
    ...
    def create_error(message: str,
                   ...
                   category: ErrorCategory = ErrorCategory.GENERAL,
                   context: Optional[Dict[str, Any]] = None,
                   original_exception: Optional[Exception] = None) -> StandardError:
        """
